...
if __name__ == '__main__':
    ...
    for state in [0.5, 1.5]:
        torch.cuda.empty_cache()

        hparams = {}
        # 
        hparams['pj_name'] = 'Vox_IEMO(3)'
        hparams['memo'] = 'emo_id_load_beta'
        ...
        hparams['id_net_freeze'] = 'arcface_finetune' #'freeze' 'arcface_finetune', 'all_finetune'
        ...
        for fold in [3,2,1,4,5]:
            hparams['fold_num'] = fold
            emo_weight = '/home/ubuntu/Dropbox/23_for_revision/with_emotion/Vox_IEMO/only_emo_hs/'+str(fold)+'_*/best_model.pt'
            if os.getcwd().split('/')[2] == 'cvnar2':
                emo_weight = emo_weight.replace('ubuntu', 'cvnar2')
            hparams['emo_weight'] = glob.glob(emo_weight)[0]
