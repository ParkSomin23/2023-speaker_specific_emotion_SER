...
if __name__ == '__main__':
    ...
    for state in ['freeze']:
        ...
        hparams['memo'] = 'emo(noSampler)_id_load_Sampler'
        ...
        for fold in range(2,6):
            ...
            hparams['emo_weight'] = glob.glob('/home/ubuntu/Dropbox/Using Speaker-specific Emotion Representations in wav2vec 2.0-based modules for SER/Vox_IEMO_REVISION/revision_only_emo/pool_4/' +\
