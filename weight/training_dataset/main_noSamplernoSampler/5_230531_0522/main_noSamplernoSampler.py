...
if __name__ == '__main__':
    ...
    for state in ['freeze']:
        ...
        hparams['memo'] = 'emo(noSampler)_id_load_noSampler'
        ...
        for fold in range(1,6):
            ...
            hparams['emo_weight'] = glob.glob('/home/ubuntu/Dropbox/Using Speaker-specific Emotion Representations in wav2vec 2.0-based modules for SER/Vox_IEMO_REVISION/revision_only_emo/' +\
