...
if __name__ == '__main__':
    ...
    for n_pool in [4]:
        ...
        for fold in range(1,6):
            ...
            hparams['emo_weight'] = glob.glob('/home/ubuntu/Dropbox/Using Speaker-specific Emotion Representations in wav2vec 2.0-based modules for SER/Vox_IEMO_REVISION/main_CE_only_emo/pool_4/'+str(fold)+'_*/best_model.pt')[0]
