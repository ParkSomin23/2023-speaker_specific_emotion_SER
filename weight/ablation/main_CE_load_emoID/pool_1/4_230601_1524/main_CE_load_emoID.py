...
if __name__ == '__main__':
    ...
    for n_pool in [3,1,2]:
        ...
        hparams['memo'] = 'emo(CE)_id(Arc)_load'
        ...
        for fold in range(1,6):
            ...
            hparams['emo_weight'] = glob.glob('/home/ubuntu/Dropbox/Using Speaker-specific Emotion Representations in wav2vec 2.0-based modules for SER/'+\
                                              'Vox_IEMO_REVISION/main_CE_only_emo/pool_'+ str(hparams['pool_head']) +'/'+str(fold)+'_*/best_model.pt')[0]
