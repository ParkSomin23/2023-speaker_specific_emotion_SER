...
if __name__ == '__main__':
    ...
    for n_pool in [1, 2, 3]:
        ...
        hparams['memo'] = 'emo(Arc)_id(Arc)_load'
        ...
        for fold in range(1,6):
            ...
            hparams['emo_weight'] = glob.glob('/home/ubuntu/Dropbox/Using Speaker-specific Emotion Representations in wav2vec 2.0-based modules for SER/weight/only_emo/'\
                                              +'pool_' + str(hparams['pool_head']) + '/' +str(fold)+'_*/best_model.pt')[0]
