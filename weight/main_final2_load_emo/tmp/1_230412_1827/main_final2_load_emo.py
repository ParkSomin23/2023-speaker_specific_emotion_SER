...
if __name__ == '__main__':
    ...
    for state in ['arcface_finetune', 'freeze', 'all_finetune']:
        torch.cuda.empty_cache()

        hparams = {}
        # 
        hparams['pj_name'] = 'Vox_IEMO(3)'
        hparams['memo'] = 'emo_id_load'
        ...
        hparams['id_net_freeze'] = state #'freeze' 'arcface_finetune', 'all_finetune'
        ...
        hparams['lr'] = 1e-6*5 #if fold == 2 else 1e-5*3
        ...
        for fold in range(1,6):
            ...
            hparams['emo_weight'] = glob.glob('/home/ubuntu/Dropbox/23_for_revision/with_emotion/Vox_IEMO/only_emo_hs/'+str(fold)+'_*/best_model.pt')[0]
