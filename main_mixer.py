...
class Emotion_Network(nn.Module):
    def __init__(self, hparams):
        ...
        self.mixer = mixer.MainMixer(self.hparams, hparams['fin_channel'])
...
def main(hparam_path):
    ...
    #Class_Len_Sampler(trainset, copy.deepcopy(hparams['use_class']), hparams['bucket_boundaries'], hparams['batch_sizes'])
...
if __name__ == '__main__':
    ...
    for n_attn in [1,4]:
        ...
        hparams = {}
        # 
        hparams['pj_name'] = 'Graduate'
        hparams['repeat_3_sec'] = True # True/False
        
        hparams['memo'] = 'only_emo_mixer(re)'
        ...
        hparams['pool_head'] = n_attn

        hparams['num_mix_blocks'] = 2
        hparams['mlp_dim'] = 512

        hparams['id_net_freeze'] = None
        ...
        #hparams['bucket_boundaries'] = list(range(1,sec+1)) #+ [20, 25, 30, 35]
        hparams['batch_sizes'] = 6
        hparams['lr'] = 1e-3*5 #if fold == 2 else 1e-5*3
